  ...
  render() {
    return (
      <>
        <CRow>
          <CCol xs="12" lg="4">
            <CWidgetIcon header="Total revenue" text="$500" color="info">
          ...
          <CCol xs="12" lg="4">
            <CWidgetIcon header="Total transferred out" text="5" color="info">
        ...
        <CModal show={this.state.setModal} onClose={this.toggle}>
          ...
          <CModalFooter>
            <CButton color="primary" onClick={this.toggle}>
              Yes
            </CButton>{" "}
