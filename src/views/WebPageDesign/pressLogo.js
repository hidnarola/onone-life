                ...
                >
                        ...
                        <CCol xs="10">
                            <CFormGroup>
                                ...
                                <div class="fileUpload btn btn-primary">
                                    ...
                                    <CInput type="file" class="upload" multiple onChange={this.uploadMultipleFiles} />
                                </div>
                    ...
                    <CModalFooter>
                        {this.state.imgSrc.length > 0 && (
                            <CButton color="primary" onClick={this.Remove}>Remove Logos</CButton>
                        )}

                        <CButton color="primary" onClick={this.props.PressLogoUpload}>Continue</CButton>{' '}
                        <CButton
                            color="secondary"
                            onClick={this.props.PressLogoUpload}
                        >Cancel</CButton>
                    </CModalFooter>
                </CModal>
