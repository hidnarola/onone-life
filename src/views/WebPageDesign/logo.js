...
class Logo extends Component {
    ...
    render() {
        return (
            <div>
                <CModal
                    show={this.props.OpenLogo}
                    onClose={this.props.LogoUpload}
                >
                    ...
                    <CModalFooter>
                        ...
                        <CButton color="primary" onClick={this.props.LogoUpload}>Continue</CButton>{' '}
                        <CButton
                            color="secondary"
                            onClick={this.props.LogoUpload}
                        >Cancel</CButton>
                    </CModalFooter>
                </CModal>
