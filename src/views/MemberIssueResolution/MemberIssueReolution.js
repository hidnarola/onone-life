  ...
  render() {
    return (
      <>
        <CRow>
          <CCol xs="12" lg="3">
            <CWidgetIcon header="Total issue" text="50" color="warning">
              <CIcon width={24} name="cil-settings" />
            </CWidgetIcon>
          </CCol>
          <CCol xs="12" lg="3">
            <CWidgetIcon header="New" text="10" color="danger">
              <CIcon width={24} name="cil-bell" />
            </CWidgetIcon>
          </CCol>

          <CCol xs="12" lg="3">
            <CWidgetIcon header="In-Progress" text="5" color="info">
              <CIcon width={24} name="cil-settings" />
            </CWidgetIcon>
          </CCol>

          <CCol xs="12" lg="3">
            <CWidgetIcon header="Resolved" text="15" color="danger">
